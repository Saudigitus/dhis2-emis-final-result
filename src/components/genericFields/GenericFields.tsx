...
import type { GenericFieldsComponentProps } from "../../types/fields/GenericFieldsTypes";

function GenericFields({
  attribute,
  disabled,
  valueType
}: GenericFieldsComponentProps) {
  switch (valueType) {
    case Attribute.valueType
    ...
    case Attribute.valueType
      .EMAIL as unknown as CustomAttributeProps["valueType"]:
    case Attribute.valueType
    ...
    case Attribute.valueType
      .INTEGER as unknown as CustomAttributeProps["valueType"]:
    case Attribute.valueType
      .INTEGER_POSITIVE as unknown as CustomAttributeProps["valueType"]:
    case Attribute.valueType
    ...
    case Attribute.valueType
      .LONG_TEXT as unknown as CustomAttributeProps["valueType"]:
      return (
        <InputArea
          {...attribute}
          disabled={!!(disabled || attribute?.disabled)}
